...
class ToolBuilder:
    def __init__(self, fs: FSOps, templates_dir: str = "workshop/toolbox/templates") -> None:
        self.fs = fs
        self.templates = Path(templates_dir)

    def build(self, name: str, description: str, workspace: str = "workshop/tools/workspace") -> str:
