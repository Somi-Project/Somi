"""
EntertainmentDomain â€” free, no-auth retrieval for entertainment realm:
...
class EntertainmentDomain:
    ...
    # Academic sources (Semantic Scholar, OpenAlex, Crossref, arXiv) â€” same as gamer_brain version

    # -----------------------------
    # Wikipedia â€” NEW: pop culture lists/overviews (public MediaWiki API, no key)
    # -----------------------------
