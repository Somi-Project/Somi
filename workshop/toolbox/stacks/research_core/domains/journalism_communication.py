"""
JournalismCommunicationDomain â€” 
...
class JournalismCommunicationDomain:
    ...
    # Sentinels / HTTP helpers â€” unchanged from previous version

    # Academic sources (Semantic Scholar, OpenAlex, Crossref, arXiv) â€” unchanged from previous version

    # -----------------------------
    # GDELT 2.0 â€” NEW: media tone & mention timelines (public, no key)
    # -----------------------------
