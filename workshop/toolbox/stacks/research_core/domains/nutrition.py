"""
NutritionDomain â€” free, no-auth nutrition / diet / metabolism research retrieval.
...
class NutritionDomain:
    ...
    async def search(self, query: str, *, retries: int = 2, backoff_factor: float = 0.5) -> List[Dict[str, Any]]:
        ...
        try:
            async with httpx.AsyncClient(
                ...
                # Parallel tasks â€” includes Open Food Facts
                tasks: List[Any] = [
    ...
    # -----------------------------
    # PubMed â€” ENHANCED: authors, journal
    # -----------------------------
    ...
    # -----------------------------
    # Europe PMC â€” ENHANCED: authors, journal, OA PDF
    # -----------------------------
    ...
    # -----------------------------
    # Crossref â€” unchanged (minimal fallback)
    # -----------------------------
    ...
    # -----------------------------
    # OpenAlex â€” ENHANCED: authors, journal, abstract recon, OA PDF
    # -----------------------------
    ...
    # -----------------------------
    # Open Food Facts â€” food composition facts (no key!)
    # -----------------------------
