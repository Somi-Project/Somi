...
AGENTPEDIA_DIR = Path("database") / "agentpedia"
AGENTPEDIA_DIR.mkdir(parents=True, exist_ok=True)

# Consolidated storage: all science stores share the Agentpedia SQLite file.
# This removes split persistence across multiple DB files under /data.
AGENTPEDIA_DB = AGENTPEDIA_DIR / "agentpedia.sqlite"

DEFAULT_VERIFIED_DB = AGENTPEDIA_DB
DEFAULT_RESEARCHED_DB = AGENTPEDIA_DB
DEFAULT_TEXTBOOK_DB = AGENTPEDIA_DB
