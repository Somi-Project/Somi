...
"""
Agentpedia Orchestrator â€” memory-first research + write-back curation.
...
from workshop.toolbox.stacks.research_core.science_stores import (
    VerifiedScienceStore,
    ResearchedScienceStore,
    TextbookFactsStore,
    AgentpediaManager,
)
from workshop.toolbox.stacks.research_core.agentpedia_kb import AgentpediaKB
    ...
    def _write_back_from_ranked(
        ...
        *,
        ...
        for r in ranked:
            ...
            fact = title
            if desc:
                fact = f"{title} â€” {safe_trim(desc, 240)}"
