...
- Renamed gamer_brain â†’ entertainment with broad triggers for movies/anime/games/awards/etc.
"""
...
BiomedDomain = _try_import("workshop.toolbox.stacks.research_core.domains.biomed", "BiomedDomain")
EngineeringDomain = _try_import("workshop.toolbox.stacks.research_core.domains.engineering", "EngineeringDomain")
NutritionDomain = _try_import("workshop.toolbox.stacks.research_core.domains.nutrition", "NutritionDomain")
ReligionDomain = _try_import("workshop.toolbox.stacks.research_core.domains.religion", "ReligionDomain")
EntertainmentDomain = _try_import("workshop.toolbox.stacks.research_core.domains.entertainment", "EntertainmentDomain")
BusinessAdministratorDomain = _try_import("workshop.toolbox.stacks.research_core.domains.business_administrator", "BusinessAdministratorDomain")
JournalismCommunicationDomain = _try_import("workshop.toolbox.stacks.research_core.domains.journalism_communication", "JournalismCommunicationDomain")
...
class ResearchRouter:
    ...
    - Chooses 1â€“2 domains for most queries.
