"""
ReligionDomain — free, no-auth retrieval for religious studies, theology,
...
class ReligionDomain:
    ...
    # -----------------------------
    # Semantic Scholar — theological research
    # -----------------------------
    ...
    # -----------------------------
    # arXiv — emerging religious studies
    # -----------------------------
    ...
    # -----------------------------
    # Wikipedia — religion overviews, figures, texts
    # -----------------------------
    ...
    # -----------------------------
    # Wikisource — sacred texts (public domain full texts)
    # -----------------------------
    ...
    # -----------------------------
    # Sacred Texts Archive — classic public domain translations
    # -----------------------------
