...
from workshop.toolbox.builder import ToolBuilder
...
class JobsEngine:
    def run_create_tool(
        ...
        fs = FSOps(WorkspaceSandbox("workshop/tools/workspace"), journal, ctx)
        ...
        try:
            ...
            tool_dir = str(Path("workshop/tools/workspace") / built_rel)
