...
CREATE INDEX IF NOT EXISTS idx_memory_sources_user_updated ON memory_sources(user_id, updated_at DESC);
CREATE INDEX IF NOT EXISTS idx_memory_sources_user_type ON memory_sources(user_id, source_type);
...
CREATE INDEX IF NOT EXISTS idx_memory_retrieval_user_created ON memory_retrieval_traces(user_id, created_at DESC);
