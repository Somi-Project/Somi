...
- 4. compare that with result 1 -> (1 ms) Simulated response: compare that with result 1
...
- 9. quick recap of our chat so far -> (1 ms) Simulated response: quick recap of our chat so far
